  ...
  <body>
    <section class="main">
      <nav>
          ...
          <form action= "login.php" ><button name="zaloguj" class=active>Zaloguj</button> </form>
      ...
      <form action="zaloguj.php" method="post">
          ...
          <button id="button4" type="submit" >Zaloguj się</button>
          <br>
          <br>
          <?php 
