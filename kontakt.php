    ...
    <br><br><br>
      <input class="menu-btn" type="checkbox" id="menu-btn">
        ...
        <ul class="menu">
          ...
          <li><a href="kontakt.php?zmienna='1'" class=active>Kontakt</a></li>
          <li><a href="o_stronie.php">O stronie</a></li>
        </ul>
      </nav>

      <div id="dodaj_wiadomosc">
      <div class="content">
      <?php 
      ...
      {
        $do_kogo = $_GET['zmienna'];
        echo '</div>';
        echo '<br><br><br><br><br><br><br><br><br>';
        echo '<form action="dodaj_wiadomosc.php" method="post" novalidate>';
        echo '<textarea id="wiadomosc" name="wiadomosc" rows="18" cols="100"></textarea><br>';
        echo '<button type="submit" class="button5" name="przycisk" value='.$do_kogo.'>Wyślij</button>';
        echo '</form>';
        echo '</div>';
      }
      ?>
