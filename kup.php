...
<html>
  ...
  <body>
   ...
   echo '<p class="testowy"> Witaj '.$_SESSION['user'].'! </p>';
    ...
    $produkty = "SELECT * FROM produkty where ID_produktu =".$s;
  ...
  //  while ($i < $num) {
   ...
   // if($i == $s){
    ...
    echo "<br><br>";
    echo '<div id="oferta">'; 
    echo "<form action='platnosc.php'  method='post' novalidate>";
    echo "<b>".$row["nazwa"]."</b>";
    ...
    echo "<br>"; 
    echo '<button class="button button1" name="buttonn" type="submit" value='.$s.'>przejdź do płatności</button>';
    echo "</form>";
    echo "</div>";
    echo "<br><br>";   
    echo "<br><br>";
