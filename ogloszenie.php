  ...
  <body>
    ...
    <!-- <button name="zaloguj">Zaloguj</button> -->
        ...
        <ul class="menu">
          ...
          <li><a href="ogloszenie.php" class="active">dodaj ogłoszenie</a></li>
      ...
      <div id="dodaj"> 
        <form action="dodaj.php" method="post" novalidate>
          Nazwa produktu: <br>  <input type="text" name="nazwa" maxlength="30" minlength="5"/><br>
          Opis produktu: <br> <input type="text" name="opis" maxlength="100" /><br>
          Dodaj zdjęcie: <br> <input type="file" name="obraz"><br>
          Cena: <br> <input type="number" name="cena" maxlength="7" min="0.01" max="99999"/><br>
          ...
          <button class="button" type="submit">Dodaj produkt</button>
