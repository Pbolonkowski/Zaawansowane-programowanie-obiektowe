...
else
{
    ...
    while ($i < $num) {
        ...
        echo "<br>";
        echo '<button class="button button2" name="odrzuc" type="sumbit" value='.$row["ID_produktu"].'>Odrzuć przedmiot</button>'; 
        echo '<button class="button button1" name="zatwierdz" type="sumbit" value='.$row["ID_produktu"].'>Zatwierdź przedmiot</button>';
        echo "</form>";
        echo "</div>";
        echo "<br><br>";   
        echo "<br><br>";      
