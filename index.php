  ...
  <body>
    <section class="main">
      <nav>
        ...
        <ul class="menu">
          <li><img src="eneba2.png" alt="obraz" id ="obraz"></li>
      ...
      <div class="header-content">
        <div class="header-text">
          <h1>Znajdź coś dla siebie! <span>Film</span>, <span>gra</span>, a może <span>książka!</span> </h1>
          <a href="przegladaj.php" class="header-btn">Przeglądaj</a>
        </div>
      </div>
