  ...
  <body>
    ...
    <div class="header-content">
        <div class="header-text">
          <h1>Płatność zakończona powodzeniem! Wkrótce na maila otrzymasz zamówiony produkt!</h1>
          <a href="glowna.php" class="header-btn">STRONA GŁÓWNA</a>
        </div>
      </div>
   ...
   // $s++;
    ...
    echo $awaryjna;
    echo $s;
    $sql = "UPDATE `produkty` SET `data_sprzedazy`='$awaryjna',`id_kupujacego`='$id' WHERE ID_produktu = $s";
