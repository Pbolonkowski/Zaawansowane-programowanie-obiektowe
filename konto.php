  ...
  <body>
   ...
   echo '<p class="testowy"> Witaj '.$_SESSION['user'].'! </p>';
    ...
    <!-- <button name="zaloguj">Zaloguj</button> -->
      ...
      <div id="przyciski">
      <form action="sprzedaz.php" method="post" novalidate>
        <button class="button button3" type="submit">Historia sprzedaży</button>
      </form>
    </div>
     
      <div id="przyciski2">
      <form action="kupno.php" method="post" novalidate>
        <button class="button button3" type="submit">Historia kupna</button>
      </form>
      </div>
      <div id="przyciski3">
      <form action="aktywne.php" method="post" novalidate>
        <button class="button button3" type="submit">Moje aktywne ogłoszenia</button>
      </form>
      </div>
